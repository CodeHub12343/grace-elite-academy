    ...
    try {
      ...
      try {
        ...
        try {
          ...
          const term = firstTerm?.term;
          const academicYear = firstTerm?.academicYear;
          ...
          console.log('❌ Terms endpoint failed:', error.response?.data || error.message);
        }

      } catch (error) {
        console.log('❌ Subjects endpoint failed:', error.response?.data || error.message);
      }
